  ...
  return (
    <div>
      <section className=" mx-auto max-w-screen-xl  pb-4 bg-white items-center flex flex-col-reverse lg:flex-row md:px-8">
        ...
        <div className="space-y-4 flex-1 sm:text-center px-10 lg:text-left">
          <h1 className="text-gray-800 font-bold text-4xl xl:text-5xl">
            <span className="text-[#FF5555] text-xl ">Features</span>
            <p className="font-black text-4xl lg:text-5xl xl:text-5xl text-black pb-5">Uifry Premium</p>
          </h1>
